/**
 * Số lượng tuyển dụng: lưu mã chuẩn trong workingLocations[].numberOfHires,
 * hiển thị theo ngôn ngữ tab (vi / en / jp).
 */

export const NUMBER_OF_HIRES_OPTION_VALUES = [
  '01',
  '02',
  '03',
  '04',
...
/** Chuỗi cũ (chỉ lưu tiếng Việt) → mã chuẩn */
 ...
 * @param {'vi'|'en'|'jp'|'ja'} lang
 */
export function getNumberOfHiresDisplayLabel(stored, lang) {
  ...
  if (L) {
    ...
    if (lang === 'jp' || lang === 'ja') return L.jp;
    return L.vi;
  }
  return s;
}
